...
**Protobook** is a Solana program for issuing a public, timebound offer to buy a token at a fixed price. It allows a private party to execute a one-to-many OTC swap with public liquidity. In this way, it represents a generalized orderbook protocol.
