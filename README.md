...
**Protobook** is a Solana program for issuing a public, timebound offer to buy a given token at a fixed price. It allows anyone to execute a one-to-many OTC swap with public liquidity. In this way, it represents a generalized and permissionless orderbook protocol.
